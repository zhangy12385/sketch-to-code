...
function BestOfNEvalsPage() {
  ...
  // UI state
  const [show结果, setShow结果] = useState(false);
                    ...
                    <table className="text-xs w-full">
                      <thead>
                        <tr className="bg-gray-700">
                          ...
                          <th className="px-2 py-1 text-gray-300">胜场</th>
                      ...
                      <tbody>
                        ...
                        {stats.ties > 0 && (
                          <tr className="border-t border-gray-600">
                            ...
                            <td className="px-2 py-1 text-zinc-300 text-center">
                              {stats.ties}
                            </td>
                            <td className="px-2 py-1 text-zinc-300 text-center">
                              {stats.tiePercentage}%
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                ...
                <div className="w-full h-[calc(100vh-200px)] flex items-center justify-center bg-gray-50 p-2">
                  <img
                    ...
                    alt={`对比 ${currentComparisonIndex + 1} 的输入`}
                ...
                <div className="bg-gray-50 px-3 py-1.5 border-b border-gray-200 flex items-center justify-between">
                  <span className="text-xs text-gray-600 font-medium">
                    ...
                    {outcomes[currentComparisonIndex] === currentModelIndex && (
                      <span className="ml-2 text-green-600">✓ 获胜</span>
                    )}
                  </span>
                  <Dialog>
